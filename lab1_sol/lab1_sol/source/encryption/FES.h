...
public:
	...
	[[nodiscard]] static BitmapImage encrypt_fast(const BitmapImage& original_image, const key_type& encryption_key);
	...
	[[nodiscard]] static block_type encrypt_block_fast(const block_type& current_block, const block_type& previous_block);
